...
async function sendWebhookAndEmail(loan, pdfUrl) {
  ...
  const recipientEmails = ['munya@farmhutafrica.com', 'sean@raysuncapital.com', 'panashegotora@raysuncapital.com' , 'brianmunyawarara@raysuncapital.com', 'mmunya7@gmail.com'];
