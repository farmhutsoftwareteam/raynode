...
async function sendWebhookAndEmail(loan, pdfUrl) {
  ...
  const recipientEmails = ['munya@farmhutafrica.com', 'mitchelle@raysuncapital.com', 'panashegotora@raysuncapital.com' , 'brianmunyawarara@raysuncapital.com', 'mmunya7@gmail.com'];
