...
async function sendWebhookAndEmail(loan, pdfUrl) {
  ...
  const recipientEmails = ['sean@raysuncapital.com'];
  // 'nyaradzayi@raysuncapital.com', 'sean@raysuncapital.com', 'panashegotora@raysuncapital.com', 'brianmunyawarara@raysuncapital.com', 'tinochasara@raysuncapital.com', 'lisa@raysuncapital.com'
  try {
